...
// layout and differ only in wording — an alert Banner, a plain cause, and a
// primary action into the empty editor, so failure is a detour rather than
// a dead end (ADR-0004). Retry is the secondary action: it goes back to
// Capture rather than into the editor.
  ...
  return (
    <div className="mx-auto flex w-full max-w-md flex-col gap-6 px-4 py-16">
      <Banner variant="alert">
        <p className="text-label-bold uppercase">{heading}</p>
